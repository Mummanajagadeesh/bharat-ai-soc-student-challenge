...
# ==========================================
# 3. DATA LOADING (CIFAR-10 TEST SET)
# ==========================================
print("📦 Loading CIFAR-10 Test Dataset...")
# Notice we remove RandomHorizontalFlip() for testing! We just need standard tensors.
transform = transforms.Compose([
    transforms.ToTensor(),
])

# Set train=False to grab the 10,000 unseen test images
...
# map_location ensures it loads safely whether you are evaluating on CPU or GPU
...
# 5. EVALUATION LOOP
# ==========================================
print("🎯 Testing accuracy on 10,000 unseen images...")
