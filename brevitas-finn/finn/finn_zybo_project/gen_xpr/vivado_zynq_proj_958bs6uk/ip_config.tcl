...
set NUM_AXILITE 2
if {$NUM_AXILITE > 99} {
    puts "Warning: Bypassed AXI-Lite limit"
}
set NUM_AXIMM 2
set BOARD Zybo-Z7-10
...
set_property ip_repo_paths [concat [get_property ip_repo_paths [current_project]] [list /tmp/finn_build_temp/code_gen_ipgen_StreamingDataflowPartition_0_IODMA_hls_0_gdh5pjfm/project_StreamingDataflowPartition_0_IODMA_hls_0/sol1/impl/ip /tmp/finn_build_temp/vivado_stitch_proj_d4gvsbgx/ip]] [current_project]
...
set_property ip_repo_paths [concat [get_property ip_repo_paths [current_project]] [list /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_0_joy2r4yh /tmp/finn_build_temp/code_gen_ipgen_FMPadding_rtl_0_p7dt8qis /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_1_xhmcix8c /tmp/finn_build_temp/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_k2r1a3lu /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_2_1bpm3wo4 /tmp/finn_build_temp/code_gen_ipgen_ConvolutionInputGenerator_rtl_0_0d6wkxmn /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_3_k1x_o08u /tmp/finn_build_temp/code_gen_ipgen_MVAU_hls_0_wkwugufv/project_MVAU_hls_0/sol1/impl/ip /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_4_am0l52or /tmp/finn_build_temp/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_m002tdcs /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_5_7lex0v8p /tmp/finn_build_temp/code_gen_ipgen_StreamingMaxPool_hls_0_gs4euiop/project_StreamingMaxPool_hls_0/sol1/impl/ip /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_6_b05ak2us /tmp/finn_build_temp/code_gen_ipgen_FMPadding_rtl_1_t9tm15b1 /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_7_iapctw1j /tmp/finn_build_temp/code_gen_ipgen_StreamingDataWidthConverter_rtl_2_oxlyxezx /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_8__krq0gcl /tmp/finn_build_temp/code_gen_ipgen_ConvolutionInputGenerator_rtl_1_7d1n7p61 /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_9_97zdnyj9 /tmp/finn_build_temp/code_gen_ipgen_MVAU_hls_1_qngchpw_/project_MVAU_hls_1/sol1/impl/ip /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_10_a9mufnkx /tmp/finn_build_temp/code_gen_ipgen_StreamingDataWidthConverter_rtl_3_rozi0zyy /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_11_du939lkm /tmp/finn_build_temp/code_gen_ipgen_StreamingMaxPool_hls_1_iypd7msa/project_StreamingMaxPool_hls_1/sol1/impl/ip /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_12_i3r274fp /tmp/finn_build_temp/code_gen_ipgen_StreamingDataWidthConverter_rtl_4_8tzekz8a /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_13_y7m415ty /tmp/finn_build_temp/code_gen_ipgen_MVAU_rtl_0_94_tq2ax /tmp/finn_build_temp/code_gen_ipgen_StreamingFIFO_rtl_14_j8i6bw_s /tmp/finn_build_temp/vivado_stitch_proj_zaovpfs1/ip $::env(FINN_ROOT)/finn-rtllib/memstream]] [current_project]
update_ip_catalog -rebuild -scan_changes
...
set_property ip_repo_paths [concat [get_property ip_repo_paths [current_project]] [list /tmp/finn_build_temp/code_gen_ipgen_StreamingDataflowPartition_2_IODMA_hls_0_bukfyuig/project_StreamingDataflowPartition_2_IODMA_hls_0/sol1/impl/ip /tmp/finn_build_temp/vivado_stitch_proj_6_se8qal/ip]] [current_project]
update_ip_catalog -rebuild -scan_changes
