...
//Date        : Fri Feb 20 16:06:39 2026
//Host        : 7af742889c22 running 64-bit Ubuntu 22.04.1 LTS
...
module StreamingFIFO_rtl_9_imp_1K6V4FD
   (ap_clk,
    ap_rst_n,
    in0_V_tdata,
    in0_V_tready,
...
(* CORE_GENERATION_INFO = "finn_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=finn_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=40,numReposBlks=32,numNonXlnxBlks=3,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=4,numHdlrefBlks=20,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "finn_design.hwdef" *) 
module finn_design
   (ap_clk,
    ap_rst_n,
    m_axis_0_tdata,
  ...
  StreamingFIFO_rtl_9_imp_1K6V4FD StreamingFIFO_rtl_9
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
