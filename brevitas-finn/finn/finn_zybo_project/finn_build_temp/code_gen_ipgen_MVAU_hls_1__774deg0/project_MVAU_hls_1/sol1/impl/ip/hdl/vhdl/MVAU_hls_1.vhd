...
architecture behav of MVAU_hls_1 is 
    ...
    "MVAU_hls_1_MVAU_hls_1,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.591000,HLS_SYN_LAT=903178,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=999,HLS_SYN_LUT=1671,HLS_VERSION=2022_2}";
...
begin
    grp_Matrix_Vector_Activate_Stream_Batch_fu_60 : component MVAU_hls_1_Matrix_Vector_Activate_Stream_Batch
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
