...
void myproject_float(
    ...
    input_t input_layer_ap[32*32*3];
    nnet::convert_data<float, input_t, 32*32*3>(input_layer, input_layer_ap);

    result_t layer18_out_ap[10];

    myproject(input_layer_ap,layer18_out_ap);

    nnet::convert_data<result_t, float, 10>(layer18_out_ap, layer18_out);
}
...
void myproject_double(
    ...
    nnet::convert_data<result_t, double, 10>(layer18_out_ap, layer18_out);
}
}
